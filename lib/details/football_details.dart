...
class Frecent extends StatefulWidget {
  final DocumentSnapshot post;
  Frecent({this.post});
  @override
  _FrecentState createState() => _FrecentState();
}

class _FrecentState extends State<Frecent> {
  back() {
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: AnimatedTextKit(
            animatedTexts: [
              TyperAnimatedText(widget.post.data['title'],
